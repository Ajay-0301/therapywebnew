...
const navItems = [
  ...
  { path: '/patient-logs', label: 'Patient Logs', icon: <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><path d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm1 3h8v2H6V6zm0 4h6v2H6v-2z"/></svg> },
  { path: '/calendar', label: 'Calendar', icon: <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><rect x="2" y="3" width="16" height="15" rx="2" /><line x1="6" y1="1" x2="6" y2="5" stroke="white" strokeWidth="1.5" /><line x1="14" y1="1" x2="14" y2="5" stroke="white" strokeWidth="1.5" /><line x1="2" y1="8" x2="18" y2="8" stroke="white" strokeWidth="1" /><rect x="5" y="10" width="3" height="2" rx="0.5" fill="white" /><rect x="10" y="10" width="3" height="2" rx="0.5" fill="white" /><rect x="5" y="14" width="3" height="2" rx="0.5" fill="white" /></svg> },
